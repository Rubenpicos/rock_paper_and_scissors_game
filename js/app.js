...
function draw(userChoice, computerChoice) {
    ...
    const smallCompWord = "(rival)".fontsize(2).sub();
    const userChoice_div = document.getElementById(userChoice)
    result_p.innerHTML = `${convertToWord(userChoice)}${smallUserWord} es igual a ${convertToWord(computerChoice)}${smallCompWord}. Es un empate!`; //quítale el small en los dos sitios
